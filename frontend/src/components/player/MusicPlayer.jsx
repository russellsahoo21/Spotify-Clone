    ...
    <>
      ...
      {isExpanded && (
        ...
        <div className="fixed inset-0 bg-black z-[100] flex flex-col p-6 pt-12 md:hidden">
          ...
          <div className="w-full aspect-square bg-black rounded-xl shadow-2xl overflow-hidden mb-6 shrink-0 flex items-center justify-center relative">
            {!showVideo ? (
              <img src={currentSong.coverImage} alt="Cover Art" className="w-full h-full object-cover" />
            ) : (
              <div className="w-full h-full flex items-center justify-center text-spotify-grey text-xs">
                {/* A subtle loading or background state for the video area */}
